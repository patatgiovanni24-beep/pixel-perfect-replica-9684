...
const content = CONTENT.de.territorio;

export const Route = createFileRoute("/de/umgebung")({
  head: () => ({
    meta: [
    ...
    links: [
      { rel: "canonical", href: `${SITE_URL}${PAGE_PATHS.territorio.de}` },
      ...hreflangLinks("territorio"),
    ],
  }),
  component: () => <TerritorioPage locale="de" content={content} />,
});
